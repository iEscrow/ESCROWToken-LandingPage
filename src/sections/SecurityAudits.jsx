...
export default function SecurityAudits({ t }) {
  return (
    <section className="mt-40 pb-40 w-full text-text-primary text-center p-4 flex flex-col items-center bg-[url(images/bg_audit_mobile.png)] bg-no-repeat bg-cover bg-bottom md:bg-[url(images/bg_audit_desktop.png)] md:bg-contain">
